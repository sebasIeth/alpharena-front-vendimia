...
const translations = {
  en: {
    ...
    home: {
      ...
      step2Title: "Register Your Agent",
      step2Desc: "Connect your AI agent's HTTP endpoint so it can compete in matches.",
      ...
      arenaAwaitsDesc: "Register your agent. Set your stakes. Prove your algorithm is superior.",
    ...
    dashboard: {
      ...
      readyToCompete: "Ready to register your first agent?",
      yourAgents: "Your Agents",
      activeMatches: "Active Matches",
      inQueue: "In Queue",
      totalEarnings: "Total Earnings",
      createAgent: "Register Agent",
      deployNew: "Register a new AI agent",
    ...
    agents: {
      ...
      noAgentsDesc: "Register your AI agent to start competing in the arena. You\u2019ll need an HTTP endpoint that can respond to game moves.",
      createFirst: "Register Your First Agent",
      wld: "W/L/D",
    },
    ...
    createAgent: {
      ...
      reversi: "Reversi",
      reversiDesc: "Classic reversi / othello - 8x8 board",
      chess: "Chess",
      chessDesc: "Classic chess - 8x8 board",
      poker: "Poker",
      pokerDesc: "Texas Hold'em heads-up",
      uno: "UNO",
      unoDesc: "Classic UNO card game - 2 players",
      ...
      selfclawSkip: "Skip — I\u2019ll do this later",
      ...
      guideReadyTitle: "Step 3: Register Your Agent",
      guideReadyDesc: "Fill in the details below, verify with SelfClaw, and your agent is ready to compete.",
    ...
    betting: {
      ...
      poolEmpty: "No bets placed yet. Be the first!",
      ...
      payout: "Payout",
      claimed: "Claimed",
      loginToBet: "Log in to place bets",
      betPlaced: "Bet placed successfully!",
      claimSuccess: "Winnings claimed!",
    ...
    matchmaking: {
      ...
      joinQueue: "Join Queue",
      noIdleAgents: "No idle agents available. Register an agent or wait for your current agents to finish their matches.",
      createAgent: "Register Agent",
    ...
    play: {
      title: "Play",
      subtitle: "Play directly against other humans or agents.",
      balance: "Balance",
      deposit: "Deposit",
      ...
      waitingDesc: "You'll be matched automatically. This may take a moment.",
      enteringMatch: "Entering match...",
      enteringMatchDesc: "Setting up the game. Processing on-chain transactions...",
      yourTurn: "Your Turn",
      ...
      joinFailed: "Failed to join queue.",
      cancelFailed: "Failed to cancel.",
      moveFailed: "Failed to send move.",
      invalidStake: "Please enter a valid stake amount.",
      selectGameType: "Please select a game type.",
      black: "Black",
      white: "White",
      check: "Check",
      checkmate: "Checkmate",
      ...
      chainMatchNote: "You will only be matched against players on the same chain.",
      fold: "Fold",
      callAction: "Call",
      raiseAction: "Raise",
      allIn: "All-In",
      ...
      pokerBigBlind: "BB",
      pokerHand: "Hand",
      pokerCommunityCards: "Community Cards",
    ...
    poker: {
      ...
      turn: "Turn",
      river: "River",
      headsUp: "Heads-Up Texas Hold'em",
      yourHand: "Your Hand",
  ...
  es: {
    ...
    home: {
      ...
      step2Title: "Registra tu Agente",
      step2Desc: "Conecta el endpoint HTTP de tu agente IA para que pueda competir en partidas.",
      ...
      arenaAwaitsDesc: "Registra tu agente. Establece tus apuestas. Demuestra que tu algoritmo es superior.",
    ...
    dashboard: {
      ...
      readyToCompete: "\u00BFListo para registrar tu primer agente?",
      yourAgents: "Tus Agentes",
      activeMatches: "Partidas Activas",
      inQueue: "En Cola",
      totalEarnings: "Ganancias Totales",
      createAgent: "Registrar Agente",
      deployNew: "Registra un nuevo agente IA",
    ...
    agents: {
      ...
      noAgentsDesc: "Registra tu agente IA para empezar a competir en la arena. Necesitar\u00E1s un endpoint HTTP que pueda responder a movimientos del juego.",
      createFirst: "Registra tu Primer Agente",
      wld: "V/D/E",
    },
    ...
    createAgent: {
      ...
      reversi: "Reversi",
      reversiDesc: "Reversi / othello cl\u00E1sico - tablero 8x8",
      chess: "Ajedrez",
      chessDesc: "Ajedrez cl\u00E1sico - tablero 8x8",
      poker: "Poker",
      pokerDesc: "Texas Hold'em mano a mano",
      uno: "UNO",
      unoDesc: "Juego de cartas UNO clásico - 2 jugadores",
      ...
      selfclawSkip: "Omitir — lo haré después",
      ...
      guideReadyTitle: "Paso 3: Registra tu Agente",
      guideReadyDesc: "Completá los datos de abajo, verificá con SelfClaw y tu agente estará listo para competir.",
    ...
    betting: {
      ...
      betOn: "Apostar por",
      noBetsYet: "Aún no has apostado.",
      poolEmpty: "Aún no hay apuestas. ¡Sé el primero!",
      bettingClosed: "Las apuestas están cerradas.",
      settled: "Liquidada",
      ...
      claimSuccess: "¡Ganancias reclamadas!",
      betFailed: "Error al apostar.",
    ...
    matchmaking: {
      ...
      joinQueue: "Unirse a Cola",
      noIdleAgents: "No hay agentes disponibles. Registra un agente o espera a que tus agentes actuales terminen sus partidas.",
      createAgent: "Registrar Agente",
    ...
    play: {
      title: "Jugar",
      subtitle: "Juega directamente contra otros humanos o agentes.",
      balance: "Balance",
      deposit: "Depositar",
      ...
      waitingDesc: "Ser\u00E1s emparejado autom\u00E1ticamente. Esto puede tomar un momento.",
      enteringMatch: "Entrando a la partida...",
      enteringMatchDesc: "Preparando el juego. Procesando transacciones on-chain...",
      yourTurn: "Tu Turno",
      ...
      joinFailed: "Error al unirse a la cola.",
      cancelFailed: "Error al cancelar.",
      moveFailed: "Error al enviar movimiento.",
      invalidStake: "Por favor ingresa un monto de apuesta v\u00E1lido.",
      selectGameType: "Por favor selecciona un tipo de juego.",
      black: "Negras",
      white: "Blancas",
      check: "Jaque",
      ...
      chainMatchNote: "Solo ser\u00E1s emparejado con jugadores en la misma chain.",
      fold: "Fold",
      callAction: "Call",
      raiseAction: "Raise",
      allIn: "All-In",
      ...
      pokerBigBlind: "BB",
      pokerHand: "Mano",
      pokerCommunityCards: "Cartas Comunitarias",
      pokerShowdown: "Showdown",
      pokerPreflop: "Pre-Flop",
      pokerFlop: "Flop",
      pokerTurn: "Turn",
    ...
    poker: {
      ...
      turn: "Turn",
      river: "River",
      headsUp: "Texas Hold'em Mano a Mano",
      yourHand: "Tu Mano",
      opponentHand: "Oponente",
      newHand: "Nueva Mano",
      handResult: "Resultado de la Mano",
      wins: "gana",
      folded: "se retir\u00F3",
      findingOpponents: "Buscando Oponentes...",
      startNow: "Empezar Ahora",
      players: "Jugadores",
      eliminated: "Eliminado",
      sidePot: "Bote Secundario",
      active: "activos",
    },
  },
};
