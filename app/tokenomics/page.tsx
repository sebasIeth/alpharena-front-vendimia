          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3">
              <div className="bg-arena-bg rounded-lg px-3 py-2">
                ...
                <code className="text-xs font-mono text-arena-primary break-all blur-sm select-none">324f2BD09e908f28217CC19Bb9599b199c736bA3</code>
              </div>
              <span
              ...
              <span
                className="inline-flex items-center gap-1.5 px-3 py-2 bg-green-500/10 text-green-700/50 text-xs font-medium rounded-lg cursor-not-allowed">
