          ...
          {balanceLoading ? (
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <div className="flex items-baseline gap-1 pt-0.5">
                <span className="text-xs font-mono tabular-nums text-arena-muted">{Number(balance.bnb).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</span>
                <span className="text-[10px] text-arena-muted">BNB</span>
              </div>
            </div>
          ) : (
